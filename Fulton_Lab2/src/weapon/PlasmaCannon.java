...
/**
 * This class implements the functionalities of the Plasma Cannon Weapon.
 * In the case of the Plasma Cannon, every time it is fired it weakens the power 
 * it has for the next shot. So a fully loaded Plasma Cannon does more damage 
 * than one with only a shot left. 
...
public class PlasmaCannon extends GenericWeapon implements Weapon
{
	 ...
	 * @param range - the max range of the Weapon
	 * @param rof - the rate of fire of the weapon
	 ...
	 *  @return Returns  the modified damage.
	 *  If the target is out of range, still expend ammo but do no damage.
	 *  If the target is in range but out of shots / ammo, do no damage
	 */
	@Override
